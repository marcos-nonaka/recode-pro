...
<title>Bora Bora Viagens - Cadastro de Destinos</title>
</head>
	...
	<main>
		<div class="container">
			...
			<h3 style="margin-top: 10px">
				Cadastro de destino <a class="btn btn-warning"
					href="./views/admin/admin-painel.html" role="button">Voltar</a>
			</h3>
			<form action="./inserir-destino" method="post" class="form-control">
				<fieldset>
					...
					<tbody>
						<jstl:forEach items="${listaDestinos}" var="destino">
							<tr>
								...
								<td>${destino.valor}</td>
								<td><a href="./editar-destino?id=${destino.id}"
									class="btn btn-success">Editar</a> <a
									href="./excluir-destino?id=${destino.id}"
